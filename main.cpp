...
{
    cout << "\t\t\t***Menu***" << endl;
    cout << "\t0)To select book" << endl;  ///поднятие меню для выбора книги среди существующих
...
void showAllBooks(short countOfBook, Book *Books)   ///функция, выводящая на экран все книги
{
...
int main()
{
    string tmpName, tmpAuthor;  ///tmp - временные переменные для работы с полями и содержанием объектов
    short var = 0, countOfBook = 1, i = 0, y = 0, addcount = 0;
    int tmpCountPage = 0;
    Book *Books = new Book[1], *tmpBooks; ///создание динамического массива Books и указателя tmpBooks
    while (1)
    {
